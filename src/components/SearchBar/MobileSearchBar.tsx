        ...
        >
          <div className="flex h-full items-center">
            <input
              ...
              className="w-[19ch] border-none bg-transparent text-blue-800 placeholder-shown:text-blue-800/50 focus:outline-solid focus:outline-transparent dark:text-white"
            />
          </div>
